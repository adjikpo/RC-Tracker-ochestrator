"""
Django settings for rc_tracker project.
...
SECRET_KEY = 'django-insecure-n8a$2m(z&#!=l+e$=4qkfp^45=9udq&qls3ht_59#c-cgzml1y'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['localhost','127.0.0.1','rc_backend.internal']
...
WSGI_APPLICATION = 'rc_tracker.wsgi.application'
...
SIMPLE_JWT = {
    ...
    "AUTH_COOKIE_SECURE": False,  # 🔒 Mettre True en production (HTTPS)
    "AUTH_COOKIE_SAMESITE": "Lax",  # Évite les attaques CSRF
}
